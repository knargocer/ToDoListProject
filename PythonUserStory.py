...
def task_modifaction():
    with open("DataJson.json") as data:
        ...
        data_dict['tasks'][task_answer]['deadline'] = input("Enter the deadline of the task")
        data_dict['tasks'][task_answer]['Time'] = input("Enter the time it will take to accomplish it")
        new_answer = {'Task': task_answer,
                      'Deadline': data_dict['tasks'][task_answer]['deadline'],
                      'Time': data_dict['tasks'][task_answer]['Time']}
